...
func CuanConverter(body interface{}, logger logger.Logger, httpResponse *http.Response, err error) error {
	if err := CuanErrorInterceptor(httpResponse, logger, err); err != nil {
		return err
	}
